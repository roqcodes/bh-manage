-- Checkout respects app_settings.capture_payments.
-- When off: order is placed with payment_status = 'not_required' (no wallet debit).
-- When on: existing wallet debit flow (payment_status = 'paid').
