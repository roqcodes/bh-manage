-- Staff refunds + atomic order stock apply (checkout decrement / cancel restore)
...
grant execute on function public.wallet_credit_user(uuid, numeric, text) to authenticated;

-- p_multiplier: -1 = reserve/decrement on place, +1 = restore on cancel
...
grant execute on function public.inventory_apply_order_stock(uuid, integer) to authenticated;
